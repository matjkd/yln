...
$(document).ready(function() {
	$('.regionControl').click(function() {

		var region_id = $(this).attr('id');

		$("li.regions").fadeOut();
		$("ul.countries").fadeTo('fast', 0.3);
		$("#" + region_id + "_country").fadeTo('fast', 1);
		$("li." + region_id + "_target").fadeIn();
		$("li." + region_id + "_target").parent().children(":first-child").fadeIn();
		
		
	});
	
	$('.countryControl').click(function() {
		...
		$("li." + country_id + "_target").fadeIn();
		$("li." + country_id + "_target").parent().children(":first-child").fadeIn();
